...
\begin{tikzpicture}[overlay, remember picture]
	\node[]() at ([xshift=\centeroffset,yshift=8.5cm]current page.center) {
		\Huge \titlefont\textbf{Pocket Checklist}
	};
	\node[]() at ([xshift=\centeroffset,yshift=7cm]current page.center) {
		\resizebox{10cm}{!}{\titlefont\textbf{\colorbox{color1}{\textcolor{white}{\aircraftlong}}}}
	};
	\node[]() at ([xshift=\centeroffset,yshift=5.5cm]current page.center) {
		\Large \titlefont\textbf{\colorbox{color1}{\textcolor{white}{REV: \today}}} \blue{}
	};
	\node[]() at ([xshift=\centeroffset,yshift=-1cm]current page.center) {
		\includegraphics[
			width=0.8\linewidth,
			page = {52},
...
\thumbfront{\begin{tabular}{c} Aircraft \\ Description \end{tabular}}{0}
\thumbfront{\begin{tabular}{c} Normal \\ Procedures \end{tabular}}{1}
\thumbfront{\begin{tabular}{c} Flight \\ Characteristics \end{tabular}}{2}
\thumbfront{\begin{tabular}{c} Emergency \\ Procedures \end{tabular}}{3}
