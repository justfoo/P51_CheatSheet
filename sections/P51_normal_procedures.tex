...
\begin{table}[ht]
    ...
    \begin{tabular} {cccccc}
        \arrayrulecolor{color5}
        %----------------------------------------
        \hline
        %----------------------------------------
        \rowcolor{color5}
        \multicolumn{6}{|c|}{\color{white}\textbf{\begin{tabular}[c]{@{}c@{}} \\ TABLE OF MANIFOLD PRESURE AND\\ RPM LIMITS FOR FLIGHT \\ \\ \end{tabular}}} \\
        %----------------------------------------
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}TAKEOFF\\ MAXIMUM\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}WAR\\ EMERGENCY\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}MILITARY\\ POWER\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}MAXIMUM\\ CONTINUOUS\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}MAXIMUM\\ CRUISE\end{tabular}}}
        \\
        %----------------------------------------
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}MANIFOLD\\ PRESSURE\end{tabular}}}
        ...
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{RPM}}
         & \multicolumn{1}{c|}{\textbf{3000}}
         & \multicolumn{1}{c|}{\textbf{3000}}
         & \multicolumn{1}{c|}{\textbf{3000}}
         & \multicolumn{1}{c|}{\textbf{2700}}
         & \multicolumn{1}{c|}{\textbf{2400}}
        \\
        %----------------------------------------
        \hline
        %----------------------------------------
...
\begin{table}[ht]
    ...
    \begin{tabular} {ccccc|}
        ...
        %----------------------------------------
        \rowcolor{color5}
        \multicolumn{5}{|c|}{\color{white}\textbf{\begin{tabular}[c]{@{}c@{}} \\ TABLE OF ENGINE INSTRUMENT LIMITS \\ \\ \end{tabular}}} \\
        %----------------------------------------
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}COOLANT\\ TEMPERATURE\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}OIL\\ TEMPERATURE\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}OIL\\ PRESSURE\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}FUEL\\ PRESSURE\end{tabular}}}
        \\
        %----------------------------------------
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}MINIMUM\end{tabular}}}
         & \multicolumn{1}{c|}{\textbf{}}
         & \multicolumn{1}{c|}{\textbf{}}
         & \multicolumn{1}{c|}{\textbf{50 PSI}}
         & \multicolumn{1}{c|}{\textbf{14 PSI}}
        \\
        %----------------------------------------
        \hline
        %----------------------------------------
        \multicolumn{1}{|c|}{\textbf{DESIRED}}
         & \multicolumn{1}{c|}{\textbf{100°--110°C}}
         & \multicolumn{1}{c|}{\textbf{70°--80°C}}
