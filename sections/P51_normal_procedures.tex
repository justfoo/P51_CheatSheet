...
\begin{tablenumerate}
    \blueitem{Prime engine}{
        \begin{subitemize}
            \item \textbf{If cold} \dotfill \textbf{3--4 SEC}
...
% \notebox{
%         If you have rolled the elevator trim tab back for the intended landing,
%         it may take considerable forward stick pressure to keep the nose down
%         until you can re-trim the plane.
% }
